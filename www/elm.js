				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Elm: ' + ('n = ' + $elm$core$String$fromInt(model.l)))
							])),
						A2(
						$elm$html$Html$span,
						_List_Nil,
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Rust: ' + ('fibonacci(n) = ' + $elm$core$String$fromInt(model.F)))
							])),
						A2(
						$elm$html$Html$span,
						_List_Nil,
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{av: $author$project$Main$initialModel, aB: $author$project$Main$subscriptions, aD: $author$project$Main$update, aE: $author$project$Main$view});
